...
describe("actions", () => {
  ...
  describe("getBlogPosts", () => {
    ...
    it("returns an array of objects", () => {
      ...
      getBlogPosts({ commit, dispatch }, { page: 1, pageSize: 10 }).then(
        result => {
  ...
  describe("getBlogPost", () => {
    ...
    describe("with blogPosts in state", () => {
      beforeEach(() => {
        state = {
          blogPosts: [
            { title: "blog post 1", urlSegment: "blog" },
            { title: "blog post 2" }
          ]
        };
      });
      ...
      it("returns an object", () => {
        ...
        getBlogPost({ commit, dispatch, state }, "blog").then(result => {
      ...
      it("commits an entry to blogPost state", () => {
        ...
        getBlogPost({ commit, dispatch, state }, "blog").then(() => {
    ...
    describe("without blogPosts in state", () => {
      ...
      it("returns an object", () => {
        ...
        getBlogPost({ commit, dispatch, state }, "").then(result => {
          expect(result).toBeDefined();
          expect(result).not.toEqual({});
        });
      });
      ...
      it("commits an entry to blogPost state", () => {
        ...
        getBlogPost({ commit, dispatch, state }, "").then(() => {
          expect(commit).toHaveBeenCalledWith("blogPost", expect.anything());
        });
      });
    });
  ...
  describe("getLandingPage", () => {
    ...
    it("returns an object", () => {
      ...
      getLandingPage({ commit, dispatch }, "").then(result => {
        expect(result).toBeDefined();
        expect(result).not.toEqual({});
      });
    });
    ...
    it("commits an entry to landingPage state", () => {
      ...
      getLandingPage({ commit, dispatch }, "").then(() => {
  ...
  describe("getHomePage", () => {
    ...
    it("returns an object", () => {
      ...
      getHomePage({ commit, dispatch }, "").then(result => {
        expect(result).toBeDefined();
        expect(result).not.toEqual({});
      });
    });
    ...
    it("commits an entry to homePage state", () => {
      ...
      getHomePage({ commit, dispatch }, "").then(() => {
  ...
  describe("getNavLinks", () => {
    ...
    describe("with homePage in state", () => {
      ...
      it("returns an array of objects", () => {
        ...
        getNavLinks({ commit, dispatch, state }, "").then(result => {
      ...
      it("commits navLinks to state", () => {
        ...
        getNavLinks({ commit, dispatch, state }, "").then(() => {
  ...
  describe("getBackgroundImages", () => {
    ...
    describe("with homePage in state", () => {
      ...
      it("returns an array of objects", () => {
        ...
        getBackgroundImages({ commit, dispatch, state }, "").then(result => {
          expect(result.length).toEqual(3);
        });
      });
      ...
      it("commits backgroundImages to state", () => {
        ...
        getBackgroundImages({ commit, dispatch, state }, "").then(() => {
          expect(commit).toHaveBeenCalledWith(
            "backgroundImages",
            expect.anything()
          );
  ...
  describe("getEntries", () => {
    it("returns an array of objects", () => {
      ...
      getEntries({ commit, dispatch }, "").then(result => {
        expect(result.length).toEqual(2);
      });
    });
    ...
    it("commits entries to state", () => {
      ...
      getEntries({ commit, dispatch }, "").then(() => {
