...
jest.mock("markdown-it-attrs", () => {});
jest.mock("markdown-it", () => () => ({
  render: jest.fn(() => "<h3>here is the source md</h3><p>trying it out</p>"),
  use: jest.fn()
}));
...
describe("ParseMarkdown", () => {
  ...
  const shallow = propsData =>
    TestUtility.shallow(ParseMarkdown, {
      propsData: {
        ...initialProps,
        ...propsData
      }
      ...
      describe("with source", () => {
        it("returns html markup", () => {
          ...
          expect(component.vm.html).toEqual(
            "<h3>here is the source md</h3><p>trying it out</p>"
          );
        });
      });
